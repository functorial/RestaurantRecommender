...
class Model9(nn.Module):
    def __init__(self, vendors, cont_idx_hi=8, misc_idx_hi=12, ptag_idx_hi=55, vtag_idx_hi=123, d_fc=256):
        ...
        # dense layers
        self.fc1 = nn.Linear(2 * (d_cont+d_misc+d_emb_ptag+d_emb_vtag + num_vendors), d_fc)
        self.fc2 = nn.Linear(d_fc, d_fc // 2)
        self.fc3 = nn.Linear(d_fc // 2, d_fc // 4)
        self.fc4 = nn.Linear(d_fc // 4, d_fc // 8)
        self.fc5 = nn.Linear(d_fc // 8, d_fc // 16)
        self.fc6 = nn.Linear(d_fc // 16, 1)
    ...
    def forward(self, c_seq, v_id):
        ...
        out = self.fc6(out)     # output is raw
        return out
